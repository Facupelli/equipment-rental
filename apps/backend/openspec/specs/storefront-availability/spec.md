...
Define how storefront catalog availability is computed for a user-requested rental period and how catalog reads obtain inventory-owned availability counts.
