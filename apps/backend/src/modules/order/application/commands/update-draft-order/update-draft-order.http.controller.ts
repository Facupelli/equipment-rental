...
import { UpdateDraftOrderParamDto, UpdateDraftOrderRequestDto } from './update-draft-order.request.dto';
import {
  BundleNotFoundError,
...
@Controller('orders/drafts/:orderId')
export class UpdateDraftOrderHttpController {
  ...
  async update(
    ...
    @Param() params: UpdateDraftOrderParamDto,
    @Body() dto: UpdateDraftOrderRequestDto,
  ): Promise<void> {
    ...
    if (result.isErr()) {
      ...
      if (error instanceof OrderDraftEditNotAllowedError) {
        throw new ProblemException(
          HttpStatus.UNPROCESSABLE_ENTITY,
          'Draft Edit Not Allowed',
          error.message,
          'errors://draft-edit-not-allowed',
        );
      }
