...
export const Route = createFileRoute("/_admin/dashboard/catalog/bundles/")({
			...
			<div className="flex items-start justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground">
						Maneja los combos de productos.
					</p>
				</div>
				...
				<Button
					variant="outline"
					nativeButton={false}
					render={<Link to="/dashboard/catalog/bundles/new">Crear Combo</Link>}
				/>
			</div>
			{/* Table card */}
					...
					<TableBody>
						{isPending ? (
							...
							<TableRow>
								...
								>
									{nameParam
										? `No se encontraron combos para ${nameParam}`
										: "No hay combos todavía. Crea el primero."}
								</TableCell>
							</TableRow>
						) : (
								...
								<TableRow
									...
									onClick={() =>
										navigate({
											...
											params: { bundleId: row.original.id },
										})
									}
