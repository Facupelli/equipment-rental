import { customerQueries } from "@/features/customer/customer.queries";
...
import { useCustomerProfileReview } from "@/features/customer/customer.queries";
    ...
    <div className="space-y-6 px-6 pb-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
        ...
        <CustomerProfileReviewActionsPanel
          ...
          onAuditorNotesChange={setAuditorNotes}
        />
      </div>
    </div>
  );
