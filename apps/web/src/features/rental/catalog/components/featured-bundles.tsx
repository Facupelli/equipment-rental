				...
				<DialogContent className="max-h-[calc(100vh-2rem)] overflow-hidden p-0 sm:max-w-5xl">
					<div className="grid max-h-[calc(100vh-2rem)] overflow-y-auto lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
						<div className="bg-muted/30">
							<div className="relative flex min-h-[280px] items-center justify-center border-b bg-white p-8 lg:min-h-full lg:border-b-0 lg:border-r">
								{bundle.imageUrl ? (
									<img
										src={`${imageBaseUrl}/${bundle.imageUrl}`}
										alt={bundle.name}
										className="max-h-[420px] w-full object-contain lg:max-h-[620px]"
									/>
								) : (
									<div className="flex h-full min-h-[280px] w-full items-center justify-center bg-muted">
	...
	return (
		<div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
			{["featured-bundle-skeleton-1", "featured-bundle-skeleton-2"].map(
				(key) => (
					<Card key={key} className="overflow-hidden rounded-xs">
