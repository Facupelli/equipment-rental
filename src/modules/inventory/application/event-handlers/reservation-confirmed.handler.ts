...
import type { EquipmentItemRepository } from "../../infrastructure/persistence/typeorm/equipment-item.repository";
	...
	async handle(event: ReservationConfirmedEvent): Promise<void> {
		...
		try {
			await this.dataSource.transaction(async (manager) => {
				...
				try {
					await this.equipmentItemRepository.saveMany(availableItems);
